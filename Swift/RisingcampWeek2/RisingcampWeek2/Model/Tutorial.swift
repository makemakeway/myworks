...
class Tutorial {
    ...
    var contentTitle = ["Step 1", "Step 2", "Step 3", "Step 4"]
    var contentImages = ["page0", "page1", "page2", "page3"]
    var contentManual = ["일기를 작성하고 싶은 날짜를 선택해주세요!", "감정을 선택하고, 마음껏 일기를 작성해주세요!", "작성을 마친 뒤 완료를 누르면 감정과 일기가 저장됩니다.", "달력에서 작성한 날짜의 감정을 확인할 수 있습니다."]
